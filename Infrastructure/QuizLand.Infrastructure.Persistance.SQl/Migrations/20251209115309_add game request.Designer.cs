...
namespace QuizLand.Infrastructure.Persistance.SQl.Migrations
{
    ...
    [Migration("20251209115309_add game request")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizLand.Domain.Models.FriendRequests.FriendRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("QuizLand.Domain.Models.Friends.Friend", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("QuizLand.Domain.Models.GameRequests.GameRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("QuizLand.Domain.Models.FriendRequests.FriendRequest", b =>
                {
                    b.HasOne("QuizLand.Domain.Models.Users.User", "Receiver")
                        .WithMany("ReciverFriendRequests")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("QuizLand.Domain.Models.Users.User", "Requester")
                        .WithMany("ReuqesterFriendRequests")
            ...
            modelBuilder.Entity("QuizLand.Domain.Models.Friends.Friend", b =>
                {
                    b.HasOne("QuizLand.Domain.Models.Users.User", "FirstUser")
                        .WithMany("FirstUserFriends")
                        .HasForeignKey("FirstUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("QuizLand.Domain.Models.Users.User", "SecondUser")
            ...
            modelBuilder.Entity("QuizLand.Domain.Models.GameRequests.GameRequest", b =>
                {
                    b.HasOne("QuizLand.Domain.Models.Users.User", "FirstUser")
                        .WithMany("FirstUserGameRequest")
                        .HasForeignKey("FirstUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("QuizLand.Domain.Models.Users.User", "SecondUser")
                        .WithMany("SecondUserGameRequest")
                        .HasForeignKey("SecondUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("QuizLand.Domain.Models.Users.User", b =>
                {
                    ...
                    b.HasOne("QuizLand.Domain.Models.Provinces.Province", "Province")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("QuizLand.Domain.Models.Users.User", b =>
                {
                    ...
                    b.Navigation("FirstUserGameRequest");
                    ...
                    b.Navigation("ReciverFriendRequests");

                    b.Navigation("ReuqesterFriendRequests");

                    b.Navigation("SecondUserFriends");

                    b.Navigation("SecondUserGameRequest");
